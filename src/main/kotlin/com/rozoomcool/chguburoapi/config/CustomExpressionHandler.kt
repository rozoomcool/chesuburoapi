...
import com.rozoomcool.chguburoapi.dto.ErrorRequest
...
//    }
//
//    @ExceptionHandler(value = [ServletException::class, EntityBadRequestException::class, IllegalArgumentException::class, BadCredentialsException::class, JwtException::class, Exception::class])
